...
public class CheckOLDProjects {

	public File file;
	public String destFolder;
	
	public CheckOLDProjects(String basePath, String destFolder){
	...
	public static void main(String[] args) {
		...
		// /home/weslley/projeto/back
		
		//String sourceFolder = "C:/Epona/ArtigoFevereiro/Log";
		String sourceFolder = "/home/weslley/projeto";
		
		String destinyFolder = sourceFolder;
		CheckOLDProjects parser = new CheckOLDProjects(sourceFolder,destinyFolder);
		parser.folderSearch();
	}
}
